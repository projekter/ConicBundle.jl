...
#ifndef CH_MATRIX_CLASSES__PSQMR_HXX
...
namespace CH_Matrix_Classes {
  ...
  */
  ...
  /** @brief PSQMR method for solving Ax=b with symmetric matrix A and
      symmetric preconditioner M=M1*M2 (M1 and M2 regular) where the
      preconditioned system is A'x'=b' with A'=M1^{-1}AM2^{-1},
      x'=M2*x and b'=M1^{-1}b.  System matrix and preconditioners are
