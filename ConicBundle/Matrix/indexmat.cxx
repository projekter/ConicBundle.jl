...
namespace CH_Matrix_Classes {
  ...
  Indexmatrix& Indexmatrix::xeya(const Indexmatrix& A, Integer d) {
    ...
    chk_set_init(*this, 1);
    if (d == 1) {
      mat_xey(nr * nc, m, A.m); return *this;
    }
    if (d == 0) {
      mat_xea(nr * nc, m, Integer(0)); return *this;
    }
    if (d == -1) {
      mat_xemy(nr * nc, m, A.m); return *this;
    }
  ...
  Indexmatrix& Indexmatrix::xpeya(const Indexmatrix& A, Integer d) {
    chk_add(*this, A);
    if (d == 1) {
      mat_xpey(nr * nc, m, A.m); return *this;
    }
    if (d == 0) {
      return *this;
    }
    if (d == -1) {
      mat_xmey(nr * nc, m, A.m); return *this;
    }
  ...
  Indexmatrix& Indexmatrix::delete_rows(const Indexmatrix& ind, bool sorted_increasingly) {
    chk_init(*this);
    chk_init(ind);
    ...
    for (j = 0; (j < nc); j++) {
      ...
      for (k = 1; k < ind.dim(); k++) {
#if (CONICBUNDLE_DEBUG>=1)
        if (ip[k] <= ip[k - 1]) MEmessage(MatrixError(ME_unspec, "Indexmatrix::delete_rows(): a row is to be deleted twice or sorted_increasingly is incorrectly set to true", MTmatrix));
#endif
  ...
  Indexmatrix& Indexmatrix::delete_cols(const Indexmatrix& ind, bool sorted_increasingly) {
    chk_init(*this);
    chk_init(ind);
    if (ind.dim() == 0) return *this;
    Indexmatrix sind;
...
#if (CONICBUNDLE_DEBUG>=1)
      if (ip[k] < j) MEmessage(MatrixError(ME_unspec, "Indexmatrix::delete_cols(): a column is to be deleted twice", MTmatrix));
#endif
  ...
  void Indexmatrix::mfile_output(std::ostream& out, ///< output stream
  ...
  Indexmatrix Indexmatrix::operator()(const Indexmatrix& v) const {
    chk_init(v);
    chk_init(*this);
    if (v.dim() == 0) return Indexmatrix(v.nr, v.nc, Integer(0));
  ...
  Indexmatrix Indexmatrix::cols(const Indexmatrix& v) const {
    chk_init(v);
    chk_init(*this);
    if (v.dim() == 0) return Indexmatrix(nr, v.dim(), Integer(0));
  ...
  Indexmatrix Indexmatrix::rows(const Indexmatrix& v) const {
    chk_init(v);
    chk_init(*this);
    if (v.dim() == 0) return Indexmatrix(v.dim(), nc, Integer(0));
  ...
  Indexmatrix& Indexmatrix::enlarge_right(Integer addnc) {
    chk_init(*this);
#if (CONICBUNDLE_DEBUG>=1)
    if (addnc < 0)
      MEmessage(MEdim(nr, nc, 0, addnc,
        "Indexmatrix::enlarge_right(Integer addnc) addnc <0", MTmatrix));
#endif
    if (addnc <= 0)
      return *this;
    ...
    if (mem_dim < nr * (nc + addnc)) {
      ...
      if (mem_dim < nr * (nc + addnc)) {
        MEmessage(MEmem(nr * (nc + addnc),
          "Indexmatrix::enlarge_right(Integer addnc) not enough memory",
          MTmatrix));
      }
      mat_xey(nr * nc, mnew, m);
      memarray->free(m);
  ...
  Indexmatrix& Indexmatrix::enlarge_below(Integer addnr) {
    chk_init(*this);
#if (CONICBUNDLE_DEBUG>=1)
    if (addnr < 0)
      MEmessage(MEdim(nr, nc, addnr, 0,
        "Indexmatrix::enlarge_below(Integer addnr) addnr <0", MTmatrix));
#endif
    if (addnr <= 0)
      return *this;
    if (nc == 0) {
    ...
    if (mem_dim < (nr + addnr) * nc) {
      ...
      if (mem_dim < (nr + addnr) * nc) {
        MEmessage(MEmem((nr + addnr) * nc,
          "Indexmatrix::enlarge_below(Integer addnr) not enough memory",
          MTmatrix));
      }
      free_oldm = 1;
    }
  ...
  Indexmatrix& Indexmatrix::enlarge_right(Integer addnc, Integer d) {
    chk_init(*this);
#if (CONICBUNDLE_DEBUG>=1)
    if (addnc < 0)
      MEmessage(MEdim(nr, nc, 0, addnc,
        "Indexmatrix::enlarge_right(Integer addnc,Integer d) addnc <0", MTmatrix));
#endif
    if (addnc <= 0)
      return *this;
    ...
    if (mem_dim < nr * (nc + addnc)) {
      ...
      if (mem_dim < nr * (nc + addnc)) {
        MEmessage(MEmem(nr * (nc + addnc),
          "Indexmatrix::enlarge_right(Integer addnc,Integer d) not enough memory",
          MTmatrix));
      }
      mat_xey(nr * nc, mnew, m);
      memarray->free(m);
  ...
  Indexmatrix& Indexmatrix::enlarge_below(Integer addnr, Integer d) {
    chk_init(*this);
#if (CONICBUNDLE_DEBUG>=1)
    if (addnr < 0)
      MEmessage(MEdim(nr, nc, addnr, 0,
        "Indexmatrix::enlarge_below(Integer addnr,Integer d) addnr <0", MTmatrix));
#endif
    if (addnr <= 0)
      return *this;
    if (nc == 0) {
    ...
    if (mem_dim < (nr + addnr) * nc) {
      ...
      if (mem_dim < (nr + addnr) * nc) {
        MEmessage(MEmem((nr + addnr) * nc,
          "Indexmatrix::enlarge_below(Integer addnr,Integer d) not enough memory",
          MTmatrix));
      }
      free_oldm = 1;
    }
  ...
  Indexmatrix& Indexmatrix::enlarge_right(Integer addnc, const Integer* dp, Integer d) {
    chk_init(*this);
#if (CONICBUNDLE_DEBUG>=1)
    if (addnc < 0)
      MEmessage(MEdim(nr, nc, 0, addnc,
        "Indexmatrix::enlarge_right(Integer addnc,const Integer* dp,Integer d) addnc <0", MTmatrix));
#endif
    if (addnc <= 0)
      return *this;
    ...
    if (mem_dim < nr * (nc + addnc)) {
      ...
      if (mem_dim < nr * (nc + addnc)) {
        MEmessage(MEmem(nr * (nc + addnc),
          "Indexmatrix::enlarge_right(Integer addnc,const Integer* dp,Integer d) not enough memory",
          MTmatrix));
      }
      mat_xey(nr * nc, mnew, m);
      memarray->free(m);
  ...
  Indexmatrix& Indexmatrix::enlarge_below(Integer addnr, const Integer* dp, Integer d) {
    chk_init(*this);
#if (CONICBUNDLE_DEBUG>=1)
    if (addnr < 0)
      MEmessage(MEdim(nr, nc, addnr, 0,
        "Indexmatrix::enlarge_below(Integer addnr,const Integer* dp,Integer d) addnr <0", MTmatrix));
#endif
    if (addnr <= 0)
      return *this;
    if (nc == 0) {
    ...
    if (mem_dim < (nr + addnr) * nc) {
      ...
      if (mem_dim < (nr + addnr) * nc) {
        MEmessage(MEmem((nr + addnr) * nc,
          "Indexmatrix::enlarge_below(Integer addnr,const Integer* dp,Integer d) not enough memory",
          MTmatrix));
      }
      free_oldm = 1;
    }
  ...
  void sortindex(const Indexmatrix& vec, Indexmatrix& ind, bool nondecreasing) {
    ...
    //heapsort<Integer,Integer>(vec.dim(),ip,vp,nondecreasing);
    if (nondecreasing)
      std::sort(ip, ip + vec.dim(), mat_less_index<Integer>(vp));
    else
      std::sort(ip, ip + vec.dim(), mat_greater_index<Integer>(vp));
  }
