/* ****************************************************************************
    ...
    File:  CBsources/QPIterativeKKTHASolver.hxx
...
#ifndef CONICBUNDLE_QPITERATIVEKKTHASOLVER_HXX
#define CONICBUNDLE_QPITERATIVEKKTHASOLVER_HXX
...
/** @brief Iterative solver for the reduced symmetric, in general
    ...
    where only H and A blocks remain, B and C are removed by Schur
    complements. If there is no A, PCG may used.

    See the text to QPKKTSolverObject for the terminology of the
    primal dual KKT System and the general outline. 

    For this class the preconditioner offered by QPKKTSubspaceHPrecond 
    may be worth to try.
 ...
 */
  ...
  class QPIterativeKKTHASolver: public QPIterativeKKTSolver
{
protected:
...
public:
  ...
  QPIterativeKKTHASolver(CH_Matrix_Classes::IterativeSolverObject* insolver,QPKKTPrecondObject* inprecond=0,CBout* cb=0,int cbinc=-1):
    QPIterativeKKTSolver(insolver,inprecond,cb,cbinc)
  {}
  ...
  {return KKTdiagx.rowdim()+KKTdiagy.rowdim();}
  };
