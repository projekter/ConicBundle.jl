/* ****************************************************************************
    ...
    File:  CBsources/LanczMaxEig.hxx
...
#ifndef CH_MATRIX_CLASSES__LANCZMAXEIG_HXX
#define CH_MATRIX_CLASSES__LANCZMAXEIG_HXX

/**  @file LanczMaxEig.hxx
    @brief header for a class implementing the abstract class CH_Matrix_Classes::Lanczos
    @version 1.0
    @date 2018-06-05
...
namespace CH_Matrix_Classes {
  ...
  */
  ...
  class LanczMaxEig :public Lanczos, protected Memarrayuser {
  private:
    ...
    Integer ncalls;    ///< counts number of calls to LanczMaxEig
    ...
    int cnvtst(Integer neigfound, Integer blocksz, Real& errc, Real eps,
      const Matrix& d, const Matrix& e, Indexmatrix& newconv);
    ...
    /// rotate the lanzos vectors to Ritz vectors
    int resort(Integer neigfound, const Indexmatrix& newconv,
      Matrix& X, Matrix& d, Matrix& e, Matrix& v);
